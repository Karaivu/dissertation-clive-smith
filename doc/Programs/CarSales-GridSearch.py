# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 18:50 2022
...
df = pd.read_excel("C:\\Users\\Csmit\\Documents\\MCAST\\Third Year\\Dissertation\\Dissertation\\dissertation-clive-smith\\doc\\Dataset\\CarSalesGrid.xlsx")
...
df = df.groupby('DateObserved')['Sales'].sum().reset_index()
